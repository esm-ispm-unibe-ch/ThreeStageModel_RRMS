...
## indicate your paths you stored the data
...
source("AD_imputation.R") #source the model will be used for rjags
set.seed(2000)
...
source("modelIPDADNMR.R") #source the model will be used for rjags
  #run the model
set.seed(2000)
